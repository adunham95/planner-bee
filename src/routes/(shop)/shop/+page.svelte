...
>
	<h1 class="text-4xl font-bold tracking-tight lg:text-6xl">Planner Bee</h1>
	<p class="mt-4 text-xl">
		Where organizing events and sending heartfelt e-cards is as easy as a breeze.
	</p>
</div>

<div
	class="grid min-h-full grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 mx-auto max-w-7xl lg:rounded-md overflow-hidden"
>
	<div class="relative flex">
		<img
			src="/images/pexels-karleykosmos-2801980.jpg"
			alt=""
			class="absolute inset-0 size-full object-cover"
		/>
		<div class="relative flex w-full flex-col items-start justify-end bg-black/40 p-8 sm:p-12">
			<h2 class="text-lg font-medium text-white/75">Beautiful E-Cards</h2>
			<p class="mt-1 text-2xl font-medium text-white">
				Send stylish, customizable e-cards for all special occasions.
			</p>
			<a
				href="/shop/ecard"
	...
	<div class="relative flex">
		<img src="/images/gathering.jpg" alt="" class="absolute inset-0 size-full object-cover" />
		<div class="relative flex w-full flex-col items-start justify-end bg-black/40 p-8 sm:p-12">
			<h2 class="text-lg font-medium text-white/75">Smart Event Management</h2>
			<p class="mt-1 text-2xl font-medium text-white">
				Seamlessly track RSVPs, schedules, and important event details in one place.
			</p>
			<a
				href="/shop/event"
				class="mt-4 rounded-md bg-white px-4 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-50"
	...
	>
		<div class="py-8 lg:w-1/3 lg:flex-none lg:py-0">
			<div class="mx-auto flex max-w-xs items-center px-4 lg:max-w-none lg:px-8">
				<svg
					class="size-8 shrink-0 text-indigo-600"
					fill="none"
					viewBox="0 0 24 24"
					stroke-width="1.5"
					stroke="currentColor"
